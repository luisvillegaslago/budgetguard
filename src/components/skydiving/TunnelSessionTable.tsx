      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title={t('skydiving.tunnel.import')}
          >
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-xs text-guard-muted uppercase tracking-wide border-b border-border">
                  <th className="px-4 py-2 font-medium">{t('skydiving.tunnel.columns.date')}</th>
                  <th className="px-4 py-2 font-medium">{t('skydiving.tunnel.columns.location')}</th>
                  <th className="px-4 py-2 font-medium">{t('skydiving.tunnel.columns.type')}</th>
                  <th className="px-4 py-2 font-medium">{t('skydiving.tunnel.columns.duration')}</th>
                  <th className="px-4 py-2 font-medium">{t('skydiving.tunnel.columns.price')}</th>
