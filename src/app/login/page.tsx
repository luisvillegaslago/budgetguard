    ...
    <div className="flex min-h-screen items-center justify-center bg-guard-dark">
      <div className="w-full max-w-sm space-y-8 px-6">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-800 shadow-sm transition-colors hover:bg-gray-50"
        >
